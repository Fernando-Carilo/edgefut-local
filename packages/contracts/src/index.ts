...
export interface SuperbetEvidenceReport {
  ...
  baseline: { n: number; events: number; by_market: { family?: string; market_key?: string; n: number; events: number; effective_n: number; sample_quality: SampleQuality; superbet_fair: { brier: Interval; log_loss: Interval; n: number }; edgefut: { brier: Interval; log_loss: Interval; n: number }; edgefut_minus_superbet_brier: Interval | null; winner: string }[]; all: { n: number; events: number; effective_n: number; sample_quality: SampleQuality; superbet_fair: { brier: Interval; log_loss: Interval; n: number }; edgefut: { brier: Interval; log_loss: Interval; n: number }; edgefut_minus_superbet_brier: Interval | null; winner: string } };
